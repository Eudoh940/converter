		...
		$.ajax({				
			...
			success : function(response){
				if(response.error == 1){	
					...
					$("#currency_conversion_rate").html("<span class='alert alert-success'><strong>Exchange Rate ("+response.currency_to+")</strong> : "+response.rate+"</span>");
					$("#currency_conversion_rate").show();
					$("#converted_currency_amount").html("<span class='alert alert-success'><strong>Converted Amount ("+response.currency_to+"</strong>) : "+response.total_converted_currency_amount+"</span>");
